...
__global__ void __launch_bounds__(1024, 1)
    SensorFromRigLogScaleUpdateRFirstKernel(
        ...
        float* const out_SensorFromRigLogScale_r_0_norm2_tot,
        float* const out_SensorFromRigLogScale_r_kp1_norm2_tot,
        size_t problem_size) {
  const int global_thread_idx = blockIdx.x * blockDim.x + threadIdx.x;
  __shared__ uint8_t inout_shared[4096];

  __shared__ float out_SensorFromRigLogScale_r_0_norm2_tot_local[1];
  ...
  SumStore<float>(out_SensorFromRigLogScale_r_0_norm2_tot_local,
                  (float*)inout_shared,
                  0,
  ...
  SumStore<float>(out_SensorFromRigLogScale_r_kp1_norm2_tot_local,
                  ...
                  global_thread_idx < problem_size,
                  r2);
  SumFlushFinal<float>(out_SensorFromRigLogScale_r_0_norm2_tot_local,
