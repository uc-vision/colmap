...
__global__ void __launch_bounds__(1024, 1) FixedCameraPinholePointResJacKernel(
  ...
  if (global_thread_idx < problem_size) {
    ReadShared1<float>((float*)inout_shared, 0, r21);
  };
  __syncthreads();
  if (global_thread_idx < problem_size) {
    r21 = r21 * r21;
    ...
    WriteIdx2<1024, float, float, float2>(
        out_res, 0 * out_res_num_alloc, global_thread_idx, r22, r23);
    r22 = r2 * r22;
    r23 = r13 * r5;
    r19 = r19 * r19;
    r19 = 1.0 / r19;
    r19 = r2 * r19;
    r23 = fmaf(r19, r23, r11 * r3);
    r11 = r0 * r7;
    r24 = r7 * r1;
    r8 = r8 * r19;
    r12 = fmaf(r13, r8, r12 * r3);
    r11 = fmaf(r12, r24, r23 * r11);
    ...
    r21 = r21 * r10;
    r11 = r11 * r21;
    r23 = fmaf(r0, r11, r23 * r6);
    r10 = r2 * r1;
    r11 = fmaf(r1, r11, r12 * r6);
    r10 = r10 * r11;
    r10 = fmaf(r6, r10, r23 * r22);
    r12 = r2 * r1;
    r20 = r0 * r7;
    r9 = r16 * r5;
    r9 = fmaf(r19, r9, r14 * r3);
    r15 = fmaf(r16, r8, r15 * r3);
    r20 = fmaf(r15, r24, r9 * r20);
    r14 = r1 * r20;
    r15 = fmaf(r15, r6, r21 * r14);
    r12 = r12 * r15;
    r14 = r0 * r20;
    r14 = fmaf(r21, r14, r9 * r6);
    r12 = fmaf(r14, r22, r6 * r12);
    r9 = r2 * r1;
    r8 = fmaf(r4, r8, r18 * r3);
    r18 = r0 * r7;
    r25 = r4 * r5;
    r25 = fmaf(r19, r25, r17 * r3);
    r24 = fmaf(r8, r24, r25 * r18);
    r18 = r1 * r24;
    r18 = fmaf(r21, r18, r8 * r6);
    r9 = r9 * r18;
    r8 = r0 * r24;
    r8 = fmaf(r21, r8, r25 * r6);
    r22 = fmaf(r8, r22, r6 * r9);
    WriteSum3<float, float>((float*)inout_shared, r10, r12, r22);
  };
  FlushSumShared<3, float>(out_point_njtr,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r22 = fmaf(r23, r23, r11 * r11);
    r12 = fmaf(r15, r15, r14 * r14);
    r10 = fmaf(r8, r8, r18 * r18);
    WriteSum3<float, float>((float*)inout_shared, r22, r12, r10);
  };
  FlushSumShared<3, float>(out_point_precond_diag,
                           ...
                           (float*)inout_shared);
  if (global_thread_idx < problem_size) {
    r10 = fmaf(r23, r14, r11 * r15);
    r11 = fmaf(r11, r18, r23 * r8);
    r18 = fmaf(r15, r18, r14 * r8);
