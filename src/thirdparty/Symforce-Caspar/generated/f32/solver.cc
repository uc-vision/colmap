...
#include "kernel_SensorFromRigLogScale_update_step_first.h"
...
#include "kernel_fixed_camera_pinhole_point_jtjnjtr_direct.h"
...
#include "kernel_fixed_rig_pinhole_jtjnjtr_direct.h"
...
#include "kernel_fixed_rig_position_prior_jtjnjtr_direct.h"
...
#include "kernel_row_fixed_rig_pinhole_jtjnjtr_direct.h"
...
GraphSolver::GraphSolver(
    ...
    : params_(params),
      ...
      SensorFromRigLogScale_num_(SensorFromRigLogScale_num_max),
      SensorFromRigLogScale_num_max_(SensorFromRigLogScale_num_max),
      ...
      ConstPinholeSensorCalibration_num_(ConstPinholeSensorCalibration_num_max),
      ConstPinholeSensorCalibration_num_max_(
          ConstPinholeSensorCalibration_num_max),
      ...
      pinhole_fixed_pose_fixed_point_num_max_(
          pinhole_fixed_pose_fixed_point_num_max),
      fixed_rig_pinhole_num_(fixed_rig_pinhole_num_max),
      fixed_rig_pinhole_num_max_(fixed_rig_pinhole_num_max),
      fixed_rig_position_prior_num_(fixed_rig_position_prior_num_max),
      fixed_rig_position_prior_num_max_(fixed_rig_position_prior_num_max),
      fixed_rig_sensor_position_prior_num_(
          fixed_rig_sensor_position_prior_num_max),
      fixed_rig_sensor_position_prior_num_max_(
          fixed_rig_sensor_position_prior_num_max),
      fixed_rig_log_scale_prior_num_(fixed_rig_log_scale_prior_num_max),
      fixed_rig_log_scale_prior_num_max_(fixed_rig_log_scale_prior_num_max),
      row_fixed_rig_pinhole_num_(row_fixed_rig_pinhole_num_max),
      row_fixed_rig_pinhole_num_max_(row_fixed_rig_pinhole_num_max),
  ...
  nodes__Point__storage_new_best_ =
      assign_and_increment<float>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__storage_current_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  nodes__SensorFromRigLogScale__storage_check_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  nodes__SensorFromRigLogScale__storage_new_best_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  facs__fixed_rig_pinhole__args__pose__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__sensor_from_rig__data_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 8 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__sensor_from_rig_log_scale__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__calib__data_ = assign_and_increment<float>(
      origin_ptr_, offset, 4 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__point__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__pixel__data_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__reprojection_loss_scale__data_ =
      assign_and_increment<float>(origin_ptr_, offset, 1 * 1, 4);
  facs__fixed_rig_position_prior__args__pose__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * fixed_rig_position_prior_num_, 4);
  facs__fixed_rig_position_prior__args__position__data_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 4 * fixed_rig_position_prior_num_, 4);
  facs__fixed_rig_position_prior__args__sqrt_information__data_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 9 * fixed_rig_position_prior_num_, 4);
  facs__fixed_rig_position_prior__args__position_loss_scale__data_ =
      assign_and_increment<float>(origin_ptr_, offset, 1 * 1, 4);
  facs__fixed_rig_sensor_position_prior__args__pose__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * fixed_rig_sensor_position_prior_num_, 4);
  facs__fixed_rig_sensor_position_prior__args__sensor_from_rig__data_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 8 * fixed_rig_sensor_position_prior_num_, 4);
  facs__fixed_rig_sensor_position_prior__args__sensor_from_rig_log_scale__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * fixed_rig_sensor_position_prior_num_, 4);
  facs__fixed_rig_sensor_position_prior__args__position__data_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  facs__fixed_rig_sensor_position_prior__args__sqrt_information__data_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 9 * fixed_rig_sensor_position_prior_num_, 4);
  facs__fixed_rig_log_scale_prior__args__sensor_from_rig_log_scale__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  facs__fixed_rig_log_scale_prior__args__target__data_ =
      assign_and_increment<float>(origin_ptr_, offset, 1 * 1, 4);
  facs__fixed_rig_log_scale_prior__args__sqrt_information__data_ =
      assign_and_increment<float>(origin_ptr_, offset, 1 * 1, 4);
  facs__row_fixed_rig_pinhole__args__pose__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * row_fixed_rig_pinhole_num_, 4);
  facs__row_fixed_rig_pinhole__args__sensor_calibration__data_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 12 * ConstPinholeSensorCalibration_num_max_, 4);
  ...
  facs__row_fixed_rig_pinhole__args__sensor_from_rig_log_scale__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * row_fixed_rig_pinhole_num_, 4);
  facs__row_fixed_rig_pinhole__args__point__idx_shared_ =
      assign_and_increment<SharedIndex>(
          origin_ptr_, offset, 1 * row_fixed_rig_pinhole_num_, 4);
  facs__row_fixed_rig_pinhole__args__pixel__data_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * row_fixed_rig_pinhole_num_, 4);
  facs__row_fixed_rig_pinhole__args__reprojection_loss_scale__data_ =
      assign_and_increment<float>(origin_ptr_, offset, 1 * 1, 4);
  ...
  facs__fixed_camera_pinhole_point__args__pixel__data_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 2 * fixed_camera_pinhole_point_num_, 4);
  ...
  facs__pinhole_fixed_pose_fixed_point__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  facs__fixed_rig_pinhole__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_position_prior__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 4 * fixed_rig_position_prior_num_, 4);
  facs__fixed_rig_sensor_position_prior__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  facs__fixed_rig_log_scale_prior__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  facs__row_fixed_rig_pinhole__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * row_fixed_rig_pinhole_num_, 4);
  facs__fixed_camera_pinhole_point__res_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * fixed_camera_pinhole_point_num_, 4);
  ...
  facs__pinhole_fixed_pose_fixed_point__args__calib__jac_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  facs__fixed_rig_pinhole__args__pose__jac_ = assign_and_increment<float>(
      origin_ptr_, offset, 12 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__sensor_from_rig_log_scale__jac_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 2 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__point__jac_ = assign_and_increment<float>(
      origin_ptr_, offset, 6 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_position_prior__args__pose__jac_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 18 * fixed_rig_position_prior_num_, 4);
  facs__fixed_rig_sensor_position_prior__args__pose__jac_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 18 * fixed_rig_sensor_position_prior_num_, 4);
  ...
  facs__fixed_rig_log_scale_prior__args__sensor_from_rig_log_scale__jac_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  facs__row_fixed_rig_pinhole__args__pose__jac_ = assign_and_increment<float>(
      origin_ptr_, offset, 12 * row_fixed_rig_pinhole_num_, 4);
  facs__row_fixed_rig_pinhole__args__sensor_from_rig_log_scale__jac_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 2 * row_fixed_rig_pinhole_num_, 4);
  facs__row_fixed_rig_pinhole__args__point__jac_ = assign_and_increment<float>(
      origin_ptr_, offset, 6 * row_fixed_rig_pinhole_num_, 4);
  facs__fixed_camera_pinhole_point__args__point__jac_ =
      assign_and_increment<float>(
          origin_ptr_, offset, 6 * fixed_camera_pinhole_point_num_, 4);
  ...
  nodes__Point__z_end__ =
      assign_and_increment<float>(origin_ptr_, offset, 0 * 0, 4);
  nodes__SensorFromRigLogScale__z_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  nodes__SensorFromRigLogScale__z_end__ =
      assign_and_increment<float>(origin_ptr_, offset, 0 * 0, 4);
  ...
  nodes__Point__p_end__ =
      assign_and_increment<float>(origin_ptr_, offset, 0 * 0, 4);
  nodes__SensorFromRigLogScale__p_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  nodes__SensorFromRigLogScale__p_end__ =
      assign_and_increment<float>(origin_ptr_, offset, 0 * 0, 4);
  ...
  nodes__Point__step_end__ =
      assign_and_increment<float>(origin_ptr_, offset, 0 * 0, 4);
  nodes__SensorFromRigLogScale__step_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  nodes__SensorFromRigLogScale__step_end__ =
      assign_and_increment<float>(origin_ptr_, offset, 0 * 0, 4);
  ...
  nodes__Point__w_ =
      assign_and_increment<float>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__w_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__r_0_ =
      assign_and_increment<float>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__r_0_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__r_k_ =
      assign_and_increment<float>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__r_k_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__Mp_ =
      assign_and_increment<float>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__Mp_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__precond_tril_ =
      assign_and_increment<float>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__precond_diag_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  nodes__SensorFromRigLogScale__precond_tril_ = assign_and_increment<float>(
      origin_ptr_, offset, 0 * SensorFromRigLogScale_num_, 4);
  ...
  facs__pinhole_fixed_pose_fixed_point__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  facs__fixed_rig_pinhole__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_position_prior__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 4 * fixed_rig_position_prior_num_, 4);
  facs__fixed_rig_sensor_position_prior__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  facs__fixed_rig_log_scale_prior__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  facs__row_fixed_rig_pinhole__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * row_fixed_rig_pinhole_num_, 4);
  facs__fixed_camera_pinhole_point__jp_ = assign_and_increment<float>(
      origin_ptr_, offset, 2 * fixed_camera_pinhole_point_num_, 4);
    ...
    for (pcg_iter_ = 0; pcg_iter_ < params_.pcg_iter_max; pcg_iter_++) {
      ...
      if (params_.pcg_rel_decrease_min != -1.0f ||
        ...
        std::swap(nodes__Point__storage_check_,
                  nodes__Point__storage_new_best_);
        std::swap(nodes__SensorFromRigLogScale__storage_check_,
                  nodes__SensorFromRigLogScale__storage_new_best_);
...
float GraphSolver::DoResJacFirst() {
  ...
  FixedRigPinholeResJacFirst(
      nodes__PinholePose__storage_current_,
      PinholePose_num_max_,
      facs__fixed_rig_pinhole__args__pose__idx_shared_,
      facs__fixed_rig_pinhole__args__sensor_from_rig__data_,
      fixed_rig_pinhole_num_max_,
      nodes__SensorFromRigLogScale__storage_current_,
      facs__fixed_rig_pinhole__args__calib__data_,
      fixed_rig_pinhole_num_max_,
      nodes__Point__storage_current_,
      Point_num_max_,
      facs__fixed_rig_pinhole__args__point__idx_shared_,
      facs__fixed_rig_pinhole__args__pixel__data_,
      fixed_rig_pinhole_num_max_,
      facs__fixed_rig_pinhole__args__reprojection_loss_scale__data_,

      facs__fixed_rig_pinhole__res_,
      fixed_rig_pinhole_num_,
      solver__res_tot_,
      ...
      facs__fixed_rig_pinhole__args__sensor_from_rig_log_scale__jac_,
      fixed_rig_pinhole_num_,
      nodes__SensorFromRigLogScale__r_k_,
      nodes__SensorFromRigLogScale__precond_diag_,
      nodes__SensorFromRigLogScale__precond_tril_,
  ...
  FixedRigPositionPriorResJacFirst(
      nodes__PinholePose__storage_current_,
      PinholePose_num_max_,
      facs__fixed_rig_position_prior__args__pose__idx_shared_,
      facs__fixed_rig_position_prior__args__position__data_,
      fixed_rig_position_prior_num_max_,
      facs__fixed_rig_position_prior__args__sqrt_information__data_,
      fixed_rig_position_prior_num_max_,
      facs__fixed_rig_position_prior__args__position_loss_scale__data_,

      facs__fixed_rig_position_prior__res_,
      fixed_rig_position_prior_num_,
      solver__res_tot_,
      nodes__PinholePose__r_k_,
      PinholePose_num_,
      nodes__PinholePose__precond_diag_,
  ...
  FixedRigSensorPositionPriorResJacFirst(
      nodes__PinholePose__storage_current_,
      PinholePose_num_max_,
      facs__fixed_rig_sensor_position_prior__args__pose__idx_shared_,
      facs__fixed_rig_sensor_position_prior__args__sensor_from_rig__data_,
      ...
      facs__fixed_rig_sensor_position_prior__res_,
      fixed_rig_sensor_position_prior_num_,
      solver__res_tot_,
      facs__fixed_rig_sensor_position_prior__args__pose__jac_,
      fixed_rig_sensor_position_prior_num_,
  ...
  FixedRigLogScalePriorResJacFirst(
      nodes__SensorFromRigLogScale__storage_current_,
      facs__fixed_rig_log_scale_prior__args__target__data_,
      facs__fixed_rig_log_scale_prior__args__sqrt_information__data_,

      facs__fixed_rig_log_scale_prior__res_,
      fixed_rig_log_scale_prior_num_,
      solver__res_tot_,
      nodes__SensorFromRigLogScale__r_k_,
      nodes__SensorFromRigLogScale__precond_diag_,
      nodes__SensorFromRigLogScale__precond_tril_,
  ...
  RowFixedRigPinholeResJacFirst(
      ...
      Point_num_max_,
      facs__row_fixed_rig_pinhole__args__point__idx_shared_,
      facs__row_fixed_rig_pinhole__args__pixel__data_,
      row_fixed_rig_pinhole_num_max_,
      facs__row_fixed_rig_pinhole__args__reprojection_loss_scale__data_,

      facs__row_fixed_rig_pinhole__res_,
      row_fixed_rig_pinhole_num_,
      solver__res_tot_,
      facs__row_fixed_rig_pinhole__args__pose__jac_,
      row_fixed_rig_pinhole_num_,
      nodes__PinholePose__r_k_,
      PinholePose_num_,
      nodes__PinholePose__precond_diag_,
      ...
      nodes__SensorFromRigLogScale__precond_diag_,
      nodes__SensorFromRigLogScale__precond_tril_,
      facs__row_fixed_rig_pinhole__args__point__jac_,
      row_fixed_rig_pinhole_num_,
      nodes__Point__r_k_,
      Point_num_,
      nodes__Point__precond_diag_,
  ...
  FixedCameraPinholePointResJacFirst(
      nodes__Point__storage_current_,
      Point_num_max_,
      facs__fixed_camera_pinhole_point__args__point__idx_shared_,
      facs__fixed_camera_pinhole_point__args__image_from_world__data_,
      ...
      facs__fixed_camera_pinhole_point__res_,
      fixed_camera_pinhole_point_num_,
      solver__res_tot_,
      nodes__Point__r_k_,
      Point_num_,
      nodes__Point__precond_diag_,
...
void GraphSolver::DoResJac() {
  ...
  FixedRigSensorPositionPriorResJac(
      nodes__PinholePose__storage_current_,
      PinholePose_num_max_,
      facs__fixed_rig_sensor_position_prior__args__pose__idx_shared_,
      facs__fixed_rig_sensor_position_prior__args__sensor_from_rig__data_,
...
void GraphSolver::DoNormalize() {
  ...
  PointNormalize(nodes__Point__precond_diag_,
                 ...
                 Point_num_,
                 Point_num_);
  z = pcg_iter_ == 0 ? nodes__SensorFromRigLogScale__p_
                     : nodes__SensorFromRigLogScale__z_;
  SensorFromRigLogScaleNormalize(nodes__SensorFromRigLogScale__precond_diag_,
                                 SensorFromRigLogScale_num_,
                                 nodes__SensorFromRigLogScale__precond_tril_,
                                 SensorFromRigLogScale_num_,
                                 nodes__SensorFromRigLogScale__r_k_,
                                 SensorFromRigLogScale_num_,
...
void GraphSolver::DoUpdateMp() {
  ...
  PointUpdateMp(nodes__Point__r_k_,
                ...
                Point_num_,
                Point_num_);
  SensorFromRigLogScaleUpdateMp(nodes__SensorFromRigLogScale__r_k_,
                                SensorFromRigLogScale_num_,
                                nodes__SensorFromRigLogScale__Mp_,
                                SensorFromRigLogScale_num_,
                                solver__beta_,
                                nodes__SensorFromRigLogScale__Mp_,
                                SensorFromRigLogScale_num_,
                                nodes__SensorFromRigLogScale__w_,
                                SensorFromRigLogScale_num_,
                                SensorFromRigLogScale_num_);
...
void GraphSolver::DoJtjpDirect() {
  ...
  PinholeFixedPointJtjnjtrDirect(
      ...
      PinholeCalib_num_,
      pinhole_fixed_point_num_);
  FixedRigPinholeJtjnjtrDirect(
      nodes__PinholePose__p_,
      PinholePose_num_,
      facs__fixed_rig_pinhole__args__pose__idx_shared_,
      facs__fixed_rig_pinhole__args__pose__jac_,
      fixed_rig_pinhole_num_,
      nodes__SensorFromRigLogScale__p_,
      facs__fixed_rig_pinhole__args__sensor_from_rig_log_scale__jac_,
      fixed_rig_pinhole_num_,
      nodes__Point__p_,
      Point_num_,
      ...
      Point_num_,
      fixed_rig_pinhole_num_);
  FixedRigSensorPositionPriorJtjnjtrDirect(
      nodes__PinholePose__p_,
      PinholePose_num_,
      facs__fixed_rig_sensor_position_prior__args__pose__idx_shared_,
      facs__fixed_rig_sensor_position_prior__args__pose__jac_,
      ...
      nodes__SensorFromRigLogScale__w_,
      fixed_rig_sensor_position_prior_num_);
  RowFixedRigPinholeJtjnjtrDirect(
      nodes__PinholePose__p_,
      PinholePose_num_,
      facs__row_fixed_rig_pinhole__args__pose__idx_shared_,
      facs__row_fixed_rig_pinhole__args__pose__jac_,
...
void GraphSolver::DoAlphaFirst() {
  ...
  PointAlphaNumeratorDenominator(nodes__Point__p_,
                                 ...
                                 solver__alpha_denominator_,
                                 Point_num_);
  SensorFromRigLogScaleAlphaNumeratorDenominator(
      nodes__SensorFromRigLogScale__p_,
      SensorFromRigLogScale_num_,
      nodes__SensorFromRigLogScale__r_k_,
      SensorFromRigLogScale_num_,
...
void GraphSolver::DoAlpha() {
  ...
  PointAlphaDenominatorOrBetaNumerator(nodes__Point__p_,
                                       ...
                                       solver__alpha_denominator_,
                                       Point_num_);
  SensorFromRigLogScaleAlphaDenominatorOrBetaNumerator(
      nodes__SensorFromRigLogScale__p_,
      SensorFromRigLogScale_num_,
      nodes__SensorFromRigLogScale__w_,
      SensorFromRigLogScale_num_,
...
void GraphSolver::DoUpdateStepFirst() {
  ...
  PointUpdateStepFirst(nodes__Point__p_,
                       ...
                       Point_num_,
                       Point_num_);
  SensorFromRigLogScaleUpdateStepFirst(nodes__SensorFromRigLogScale__p_,
                                       SensorFromRigLogScale_num_,
                                       solver__alpha_,
                                       nodes__SensorFromRigLogScale__step_,
                                       SensorFromRigLogScale_num_,
                                       SensorFromRigLogScale_num_);
...
void GraphSolver::DoUpdateStep() {
  ...
  PointUpdateStep(nodes__Point__step_,
                  ...
                  Point_num_,
                  Point_num_);
  SensorFromRigLogScaleUpdateStep(nodes__SensorFromRigLogScale__step_,
                                  SensorFromRigLogScale_num_,
                                  nodes__SensorFromRigLogScale__p_,
                                  SensorFromRigLogScale_num_,
                                  solver__alpha_,
...
void GraphSolver::DoUpdateRFirst() {
  ...
  SensorFromRigLogScaleUpdateRFirst(nodes__SensorFromRigLogScale__r_k_,
                                    SensorFromRigLogScale_num_,
                                    nodes__SensorFromRigLogScale__w_,
                                    SensorFromRigLogScale_num_,
                                    solver__neg_alpha_,
...
void GraphSolver::DoUpdateR() {
  ...
  PointUpdateR(nodes__Point__r_k_,
               ...
               solver__r_kp1_norm2_tot_,
               Point_num_);
  SensorFromRigLogScaleUpdateR(nodes__SensorFromRigLogScale__r_k_,
                               SensorFromRigLogScale_num_,
                               nodes__SensorFromRigLogScale__w_,
                               SensorFromRigLogScale_num_,
                               solver__neg_alpha_,
...
float GraphSolver::DoRetractScore() {
  ...
  PointRetract(nodes__Point__storage_current_,
               ...
               Point_num_max_,
               Point_num_);
  SensorFromRigLogScaleRetract(nodes__SensorFromRigLogScale__storage_current_,
                               SensorFromRigLogScale_num_max_,
                               nodes__SensorFromRigLogScale__step_,
                               SensorFromRigLogScale_num_,
  ...
  FixedRigPositionPriorScore(
      ...
      solver__res_tot_,
      fixed_rig_position_prior_num_);
  FixedRigSensorPositionPriorScore(
      nodes__PinholePose__storage_check_,
      PinholePose_num_max_,
      facs__fixed_rig_sensor_position_prior__args__pose__idx_shared_,
      facs__fixed_rig_sensor_position_prior__args__sensor_from_rig__data_,
      ...
      solver__res_tot_,
      fixed_rig_sensor_position_prior_num_);
  FixedRigLogScalePriorScore(
      nodes__SensorFromRigLogScale__storage_check_,
      facs__fixed_rig_log_scale_prior__args__target__data_,
      facs__fixed_rig_log_scale_prior__args__sqrt_information__data_,
      solver__res_tot_,
      fixed_rig_log_scale_prior_num_);
  RowFixedRigPinholeScore(
      nodes__PinholePose__storage_check_,
      PinholePose_num_max_,
      facs__row_fixed_rig_pinhole__args__pose__idx_shared_,
      facs__row_fixed_rig_pinhole__args__sensor_calibration__data_,
...
void GraphSolver::DoUpdateP() {
  ...
  PointUpdateP(nodes__Point__z_,
               ...
               Point_num_,
               Point_num_);
  SensorFromRigLogScaleUpdateP(nodes__SensorFromRigLogScale__z_,
                               SensorFromRigLogScale_num_,
                               nodes__SensorFromRigLogScale__p_,
                               SensorFromRigLogScale_num_,
                               solver__beta_,
...
float GraphSolver::GetPredDecrease() {
  ...
  PointPredDecreaseTimesTwo(nodes__Point__step_,
                            ...
                            solver__pred_decrease_tot_,
                            Point_num_);
  SensorFromRigLogScalePredDecreaseTimesTwo(
      nodes__SensorFromRigLogScale__step_,
      SensorFromRigLogScale_num_,
      nodes__SensorFromRigLogScale__precond_diag_,
      SensorFromRigLogScale_num_,
      solver__current_diag_,
      nodes__SensorFromRigLogScale__r_0_,
      SensorFromRigLogScale_num_,
      solver__pred_decrease_tot_,
      SensorFromRigLogScale_num_);
...
void GraphSolver::SetSensorFromRigLogScaleNum(const size_t num) {
  cudaSetDevice(device_id_);
  if (num > SensorFromRigLogScale_num_max_) {
    throw std::runtime_error(std::to_string(num) +
                             " > SensorFromRigLogScale_num_max_");
  }
  SensorFromRigLogScale_num_ = num;
}

void GraphSolver::SetSensorFromRigLogScaleNodesFromStackedHost(
    const float* const data, const size_t offset, const size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > SensorFromRigLogScale_num_) {
    throw std::runtime_error(std::to_string(offset + num) +
                             " > SensorFromRigLogScale_num_");
  }
  cudaMemcpy(marker__scratch_inout_,
             ...
             1 * num * sizeof(float),
             cudaMemcpyHostToDevice);
  SensorFromRigLogScaleStackedToCaspar(
      marker__scratch_inout_,
      nodes__SensorFromRigLogScale__storage_current_,
      SensorFromRigLogScale_num_max_,
      offset,
...
void GraphSolver::SetSensorFromRigLogScaleNodesFromStackedDevice(
    const float* const data, const size_t offset, const size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > SensorFromRigLogScale_num_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::GetSensorFromRigLogScaleNodesToStackedHost(
    float* const data, const size_t offset, const size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > SensorFromRigLogScale_num_) {
    throw std::runtime_error(std::to_string(offset + num) +
  ...
  SensorFromRigLogScaleCasparToStacked(
      nodes__SensorFromRigLogScale__storage_current_,
      marker__scratch_inout_,
      SensorFromRigLogScale_num_max_,
      offset,
...
void GraphSolver::GetSensorFromRigLogScaleNodesToStackedDevice(
    float* const data, const size_t offset, const size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > SensorFromRigLogScale_num_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetFixedRigPinholeNum(const size_t num) {
  if (num > fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(num) +
                             " > fixed_rig_pinhole_num_max_");
  }
  fixed_rig_pinhole_num_ = num;
}
void GraphSolver::SetFixedRigPinholePoseIndicesFromHost(
    const unsigned int* const indices, size_t num) {
  cudaSetDevice(device_id_);
  if (num != fixed_rig_pinhole_num_) {
    throw std::runtime_error(std::to_string(num) +
                             " != fixed_rig_pinhole_num_. Use "
                             "Setfixed_rig_pinholeNum before setting indices.");
  }
  cudaMemcpy((unsigned int*)marker__scratch_inout_,
             indices,
             num * sizeof(unsigned int),
             cudaMemcpyHostToDevice);
  SetFixedRigPinholePoseIndicesFromDevice((unsigned int*)marker__scratch_inout_,
                                          num);
}

void GraphSolver::SetFixedRigPinholePoseIndicesFromDevice(
    const unsigned int* const indices, size_t num) {
  indices_valid_ = false;
  cudaSetDevice(device_id_);
  ...
  SharedIndices(indices, facs__fixed_rig_pinhole__args__pose__idx_shared_, num);
}
void GraphSolver::SetFixedRigPinholePointIndicesFromHost(
    const unsigned int* const indices, size_t num) {
  cudaSetDevice(device_id_);
  if (num != fixed_rig_pinhole_num_) {
    throw std::runtime_error(std::to_string(num) +
  ...
  cudaMemcpy((unsigned int*)marker__scratch_inout_,
             ...
             num * sizeof(unsigned int),
             cudaMemcpyHostToDevice);
  SetFixedRigPinholePointIndicesFromDevice(
      (unsigned int*)marker__scratch_inout_, num);
}

void GraphSolver::SetFixedRigPinholePointIndicesFromDevice(
    const unsigned int* const indices, size_t num) {
  indices_valid_ = false;
  cudaSetDevice(device_id_);
  ...
  SharedIndices(
      indices, facs__fixed_rig_pinhole__args__point__idx_shared_, num);
}
void GraphSolver::SetFixedRigPinholeSensorFromRigDataFromStackedHost(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
                             " > fixed_rig_pinhole_num_max_");
  }
  cudaMemcpy(marker__scratch_inout_,
...
void GraphSolver::SetFixedRigPinholeSensorFromRigDataFromStackedDevice(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetFixedRigPinholeCalibDataFromStackedHost(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
  ...
  cudaMemcpy(marker__scratch_inout_,
             ...
             4 * num * sizeof(float),
             cudaMemcpyHostToDevice);
  ConstPinholeCalibStackedToCaspar(marker__scratch_inout_,
                                   facs__fixed_rig_pinhole__args__calib__data_,
                                   fixed_rig_pinhole_num_max_,
                                   offset,
                                   num);
...
void GraphSolver::SetFixedRigPinholeCalibDataFromStackedDevice(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
  ...
  ConstPinholeCalibStackedToCaspar(data,
                                   facs__fixed_rig_pinhole__args__calib__data_,
                                   fixed_rig_pinhole_num_max_,
                                   offset,
                                   num);
}
void GraphSolver::SetFixedRigPinholePixelDataFromStackedHost(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetFixedRigPinholePixelDataFromStackedDevice(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetFixedRigPinholeReprojectionLossScaleDataFromStackedHost(
  ...
  cudaMemcpy(marker__scratch_inout_,
             ...
             1 * num * sizeof(float),
             cudaMemcpyHostToDevice);
  ConstReprojectionLossScaleStackedToCaspar(
      marker__scratch_inout_,
      facs__fixed_rig_pinhole__args__reprojection_loss_scale__data_,
      1,
      offset,
...
void GraphSolver::SetFixedRigPinholeReprojectionLossScaleDataFromStackedDevice(
    const float* const data) {
  cudaSetDevice(device_id_);
  const size_t offset = 0;
  const size_t num = 1;
...
void GraphSolver::SetFixedRigPositionPriorNum(const size_t num) {
  if (num > fixed_rig_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(num) +
                             " > fixed_rig_position_prior_num_max_");
  }
  fixed_rig_position_prior_num_ = num;
}
void GraphSolver::SetFixedRigPositionPriorPoseIndicesFromHost(
    const unsigned int* const indices, size_t num) {
  cudaSetDevice(device_id_);
  if (num != fixed_rig_position_prior_num_) {
    throw std::runtime_error(
        std::to_string(num) +
        " != fixed_rig_position_prior_num_. Use Setfixed_rig_position_priorNum "
        "before setting indices.");
  }
  cudaMemcpy((unsigned int*)marker__scratch_inout_,
             indices,
             num * sizeof(unsigned int),
             cudaMemcpyHostToDevice);
  SetFixedRigPositionPriorPoseIndicesFromDevice(
      (unsigned int*)marker__scratch_inout_, num);
}

void GraphSolver::SetFixedRigPositionPriorPoseIndicesFromDevice(
    const unsigned int* const indices, size_t num) {
  indices_valid_ = false;
  cudaSetDevice(device_id_);
  ...
  SharedIndices(
      indices, facs__fixed_rig_position_prior__args__pose__idx_shared_, num);
}
void GraphSolver::SetFixedRigPositionPriorPositionDataFromStackedHost(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
                             " > fixed_rig_position_prior_num_max_");
  }
  cudaMemcpy(marker__scratch_inout_,
             ...
             3 * num * sizeof(float),
             cudaMemcpyHostToDevice);
  ConstReferencePositionStackedToCaspar(
      marker__scratch_inout_,
      facs__fixed_rig_position_prior__args__position__data_,
      fixed_rig_position_prior_num_max_,
      offset,
...
void GraphSolver::SetFixedRigPositionPriorPositionDataFromStackedDevice(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetFixedRigPositionPriorSqrtInformationDataFromStackedHost(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
  ...
  cudaMemcpy(marker__scratch_inout_,
             ...
             9 * num * sizeof(float),
             cudaMemcpyHostToDevice);
  ConstPositionSqrtInformationStackedToCaspar(
      marker__scratch_inout_,
      facs__fixed_rig_position_prior__args__sqrt_information__data_,
      fixed_rig_position_prior_num_max_,
      offset,
...
void GraphSolver::SetFixedRigPositionPriorSqrtInformationDataFromStackedDevice(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetFixedRigPositionPriorPositionLossScaleDataFromStackedHost(
    const float* const data) {
  cudaSetDevice(device_id_);
  const size_t offset = 0;
  const size_t num = 1;
  ...
  cudaMemcpy(marker__scratch_inout_,
             ...
             1 * num * sizeof(float),
             cudaMemcpyHostToDevice);
  ConstPositionLossScaleStackedToCaspar(
      marker__scratch_inout_,
      facs__fixed_rig_position_prior__args__position_loss_scale__data_,
      1,
      offset,
...
void GraphSolver::
    SetFixedRigPositionPriorPositionLossScaleDataFromStackedDevice(
        const float* const data) {
  cudaSetDevice(device_id_);
  const size_t offset = 0;
  const size_t num = 1;
...
void GraphSolver::SetFixedRigSensorPositionPriorNum(const size_t num) {
  if (num > fixed_rig_sensor_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(num) +
                             " > fixed_rig_sensor_position_prior_num_max_");
  }
  fixed_rig_sensor_position_prior_num_ = num;
}
void GraphSolver::SetFixedRigSensorPositionPriorPoseIndicesFromHost(
    const unsigned int* const indices, size_t num) {
  cudaSetDevice(device_id_);
  if (num != fixed_rig_sensor_position_prior_num_) {
    throw std::runtime_error(
        std::to_string(num) +
        " != fixed_rig_sensor_position_prior_num_. Use "
        "Setfixed_rig_sensor_position_priorNum before setting indices.");
  }
  cudaMemcpy((unsigned int*)marker__scratch_inout_,
             indices,
             num * sizeof(unsigned int),
             cudaMemcpyHostToDevice);
  SetFixedRigSensorPositionPriorPoseIndicesFromDevice(
      (unsigned int*)marker__scratch_inout_, num);
}

void GraphSolver::SetFixedRigSensorPositionPriorPoseIndicesFromDevice(
    const unsigned int* const indices, size_t num) {
  indices_valid_ = false;
  cudaSetDevice(device_id_);
...
void GraphSolver::
    SetFixedRigSensorPositionPriorSensorFromRigDataFromStackedHost(
        const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_sensor_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
                             " > fixed_rig_sensor_position_prior_num_max_");
  }
  cudaMemcpy(marker__scratch_inout_,
...
void GraphSolver::
    SetFixedRigSensorPositionPriorSensorFromRigDataFromStackedDevice(
        const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_sensor_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetFixedRigSensorPositionPriorPositionDataFromStackedHost(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_sensor_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetFixedRigSensorPositionPriorPositionDataFromStackedDevice(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_sensor_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::
    SetFixedRigSensorPositionPriorSqrtInformationDataFromStackedHost(
        const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_sensor_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::
    SetFixedRigSensorPositionPriorSqrtInformationDataFromStackedDevice(
        const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_rig_sensor_position_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetFixedRigLogScalePriorNum(const size_t num) {
  if (num > fixed_rig_log_scale_prior_num_max_) {
    throw std::runtime_error(std::to_string(num) +
                             " > fixed_rig_log_scale_prior_num_max_");
  }
  fixed_rig_log_scale_prior_num_ = num;
}
void GraphSolver::SetFixedRigLogScalePriorTargetDataFromStackedHost(
    const float* const data) {
  cudaSetDevice(device_id_);
  const size_t offset = 0;
  const size_t num = 1;
  if (offset + num > fixed_rig_log_scale_prior_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
                             " > fixed_rig_log_scale_prior_num_max_");
  }
  cudaMemcpy(marker__scratch_inout_,
             ...
             1 * num * sizeof(float),
             cudaMemcpyHostToDevice);
  ConstLogScalePriorTargetStackedToCaspar(
      marker__scratch_inout_,
      facs__fixed_rig_log_scale_prior__args__target__data_,
      1,
      offset,
...
void GraphSolver::SetFixedRigLogScalePriorTargetDataFromStackedDevice(
    const float* const data) {
  cudaSetDevice(device_id_);
  const size_t offset = 0;
  const size_t num = 1;
...
void GraphSolver::SetFixedRigLogScalePriorSqrtInformationDataFromStackedHost(
    const float* const data) {
  cudaSetDevice(device_id_);
  const size_t offset = 0;
  const size_t num = 1;
  ...
  cudaMemcpy(marker__scratch_inout_,
             ...
             1 * num * sizeof(float),
             cudaMemcpyHostToDevice);
  ConstLogScalePriorSqrtInformationStackedToCaspar(
      marker__scratch_inout_,
      facs__fixed_rig_log_scale_prior__args__sqrt_information__data_,
      1,
      offset,
...
void GraphSolver::SetFixedRigLogScalePriorSqrtInformationDataFromStackedDevice(
    const float* const data) {
  cudaSetDevice(device_id_);
  const size_t offset = 0;
  const size_t num = 1;
...
void GraphSolver::SetRowFixedRigPinholeNum(const size_t num) {
  if (num > row_fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(num) +
                             " > row_fixed_rig_pinhole_num_max_");
  }
  row_fixed_rig_pinhole_num_ = num;
}
void GraphSolver::SetRowFixedRigPinholePoseIndicesFromHost(
    const unsigned int* const indices, size_t num) {
  cudaSetDevice(device_id_);
  if (num != row_fixed_rig_pinhole_num_) {
    throw std::runtime_error(
        std::to_string(num) +
        " != row_fixed_rig_pinhole_num_. Use Setrow_fixed_rig_pinholeNum "
        "before setting indices.");
  }
  cudaMemcpy((unsigned int*)marker__scratch_inout_,
             indices,
             num * sizeof(unsigned int),
             cudaMemcpyHostToDevice);
  SetRowFixedRigPinholePoseIndicesFromDevice(
      (unsigned int*)marker__scratch_inout_, num);
}

void GraphSolver::SetRowFixedRigPinholePoseIndicesFromDevice(
    const unsigned int* const indices, size_t num) {
  indices_valid_ = false;
  cudaSetDevice(device_id_);
  ...
  SharedIndices(
      indices, facs__row_fixed_rig_pinhole__args__pose__idx_shared_, num);
}
void GraphSolver::SetRowFixedRigPinholePointIndicesFromHost(
    const unsigned int* const indices, size_t num) {
  cudaSetDevice(device_id_);
  if (num != row_fixed_rig_pinhole_num_) {
    throw std::runtime_error(
  ...
  cudaMemcpy((unsigned int*)marker__scratch_inout_,
             ...
             num * sizeof(unsigned int),
             cudaMemcpyHostToDevice);
  SetRowFixedRigPinholePointIndicesFromDevice(
      (unsigned int*)marker__scratch_inout_, num);
}

void GraphSolver::SetRowFixedRigPinholePointIndicesFromDevice(
    const unsigned int* const indices, size_t num) {
  indices_valid_ = false;
  cudaSetDevice(device_id_);
  ...
  SharedIndices(
      indices, facs__row_fixed_rig_pinhole__args__point__idx_shared_, num);
}
void GraphSolver::SetRowFixedRigPinholeSensorCalibrationDataFromStackedHost(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > ConstPinholeSensorCalibration_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
                             " > ConstPinholeSensorCalibration_num_max_");
  }
  cudaMemcpy(marker__scratch_inout_,
             ...
             11 * num * sizeof(float),
             cudaMemcpyHostToDevice);
  ConstPinholeSensorCalibrationStackedToCaspar(
      marker__scratch_inout_,
      facs__row_fixed_rig_pinhole__args__sensor_calibration__data_,
      ConstPinholeSensorCalibration_num_max_,
      offset,
...
void GraphSolver::SetRowFixedRigPinholeSensorCalibrationDataFromStackedDevice(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > ConstPinholeSensorCalibration_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetRowFixedRigPinholeSensorCalibrationIndicesFromHost(
    const unsigned int* const indices, size_t num) {
  cudaSetDevice(device_id_);
  if (num != row_fixed_rig_pinhole_num_) {
    throw std::runtime_error(
  ...
  cudaMemcpy((unsigned int*)marker__scratch_inout_,
             ...
             num * sizeof(unsigned int),
             cudaMemcpyHostToDevice);
  SetRowFixedRigPinholeSensorCalibrationIndicesFromDevice(
      (unsigned int*)marker__scratch_inout_, num);
}

void GraphSolver::SetRowFixedRigPinholeSensorCalibrationIndicesFromDevice(
    const unsigned int* const indices, size_t num) {
  indices_valid_ = false;
  cudaSetDevice(device_id_);
  if (num != row_fixed_rig_pinhole_num_) {
...
void GraphSolver::SetRowFixedRigPinholePixelDataFromStackedHost(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > row_fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
                             " > row_fixed_rig_pinhole_num_max_");
  }
  cudaMemcpy(marker__scratch_inout_,
...
void GraphSolver::SetRowFixedRigPinholePixelDataFromStackedDevice(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > row_fixed_rig_pinhole_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
void GraphSolver::SetRowFixedRigPinholeReprojectionLossScaleDataFromStackedHost(
    const float* const data) {
  cudaSetDevice(device_id_);
  const size_t offset = 0;
  const size_t num = 1;
...
void GraphSolver::
    SetRowFixedRigPinholeReprojectionLossScaleDataFromStackedDevice(
        const float* const data) {
  cudaSetDevice(device_id_);
  const size_t offset = 0;
  const size_t num = 1;
...
void GraphSolver::SetFixedCameraPinholePointNum(const size_t num) {
  if (num > fixed_camera_pinhole_point_num_max_) {
    throw std::runtime_error(std::to_string(num) +
                             " > fixed_camera_pinhole_point_num_max_");
  }
  fixed_camera_pinhole_point_num_ = num;
}
void GraphSolver::SetFixedCameraPinholePointPointIndicesFromHost(
    const unsigned int* const indices, size_t num) {
  cudaSetDevice(device_id_);
  if (num != fixed_camera_pinhole_point_num_) {
    throw std::runtime_error(
        std::to_string(num) +
        " != fixed_camera_pinhole_point_num_. Use "
        "Setfixed_camera_pinhole_pointNum before setting indices.");
  }
  cudaMemcpy((unsigned int*)marker__scratch_inout_,
             indices,
             num * sizeof(unsigned int),
             cudaMemcpyHostToDevice);
  SetFixedCameraPinholePointPointIndicesFromDevice(
      (unsigned int*)marker__scratch_inout_, num);
}

void GraphSolver::SetFixedCameraPinholePointPointIndicesFromDevice(
    const unsigned int* const indices, size_t num) {
  indices_valid_ = false;
  cudaSetDevice(device_id_);
  ...
  SharedIndices(
      indices, facs__fixed_camera_pinhole_point__args__point__idx_shared_, num);
}
...
void GraphSolver::SetFixedCameraPinholePointImageFromWorldIndicesFromHost(
    const unsigned int* const indices, size_t num) {
  cudaSetDevice(device_id_);
  if (num != fixed_camera_pinhole_point_num_) {
    throw std::runtime_error(
  ...
  cudaMemcpy((unsigned int*)marker__scratch_inout_,
             ...
             num * sizeof(unsigned int),
             cudaMemcpyHostToDevice);
  SetFixedCameraPinholePointImageFromWorldIndicesFromDevice(
      (unsigned int*)marker__scratch_inout_, num);
}

void GraphSolver::SetFixedCameraPinholePointImageFromWorldIndicesFromDevice(
    const unsigned int* const indices, size_t num) {
  indices_valid_ = false;
  cudaSetDevice(device_id_);
  if (num != fixed_camera_pinhole_point_num_) {
...
void GraphSolver::SetFixedCameraPinholePointPixelDataFromStackedHost(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_camera_pinhole_point_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
                             " > fixed_camera_pinhole_point_num_max_");
  }
  cudaMemcpy(marker__scratch_inout_,
...
void GraphSolver::SetFixedCameraPinholePointPixelDataFromStackedDevice(
    const float* const data, size_t offset, size_t num) {
  cudaSetDevice(device_id_);
  if (offset + num > fixed_camera_pinhole_point_num_max_) {
    throw std::runtime_error(std::to_string(offset + num) +
...
size_t GraphSolver::get_nbytes() {
  ...
  increment_offset<float>(offset, 4 * Point_num_, 4);
  increment_offset<float>(offset, 4 * Point_num_, 4);
  increment_offset<float>(offset, 1 * SensorFromRigLogScale_num_, 4);
  increment_offset<float>(offset, 1 * SensorFromRigLogScale_num_, 4);
  increment_offset<float>(offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  increment_offset<SharedIndex>(offset, 1 * fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 8 * fixed_rig_pinhole_num_, 4);
  increment_offset<SharedIndex>(offset, 1 * fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 4 * fixed_rig_pinhole_num_, 4);
  increment_offset<SharedIndex>(offset, 1 * fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 2 * fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 1 * 1, 4);
  increment_offset<SharedIndex>(offset, 1 * fixed_rig_position_prior_num_, 4);
  increment_offset<float>(offset, 4 * fixed_rig_position_prior_num_, 4);
  increment_offset<float>(offset, 9 * fixed_rig_position_prior_num_, 4);
  increment_offset<float>(offset, 1 * 1, 4);
  increment_offset<SharedIndex>(
      offset, 1 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<float>(offset, 8 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<SharedIndex>(
      offset, 1 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<float>(offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<float>(offset, 9 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<SharedIndex>(offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  increment_offset<float>(offset, 1 * 1, 4);
  increment_offset<float>(offset, 1 * 1, 4);
  increment_offset<SharedIndex>(offset, 1 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<float>(
      offset, 12 * ConstPinholeSensorCalibration_num_max_, 4);
  increment_offset<SharedIndex>(offset, 1 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<SharedIndex>(offset, 1 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<SharedIndex>(offset, 1 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 2 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 1 * 1, 4);
  increment_offset<SharedIndex>(offset, 1 * fixed_camera_pinhole_point_num_, 4);
  increment_offset<float>(offset, 12 * ConstImageFromWorld_num_max_, 4);
  increment_offset<SharedIndex>(offset, 1 * fixed_camera_pinhole_point_num_, 4);
  increment_offset<float>(offset, 2 * fixed_camera_pinhole_point_num_, 4);
  increment_offset<SharedIndex>(
  ...
  at_least = std::max(
      ...
      offset + std::max({4 * PinholeCalib_num_max_,
                         ...
                         3 * Point_num_max_,
                         1 * SensorFromRigLogScale_num_max_,
                         ...
                         11 * ConstPinholeSensorCalibration_num_max_}) *
                   sizeof(float));
  increment_offset<float>(offset, 0 * 0, 4);
  increment_offset<float>(offset, 2 * simple_radial_num_, 4);
  increment_offset<float>(offset, 2 * simple_radial_fixed_pose_num_, 4);
  ...
  increment_offset<float>(offset, 4 * fixed_rig_position_prior_num_, 4);
  increment_offset<float>(offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<float>(offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  increment_offset<float>(offset, 2 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 2 * fixed_camera_pinhole_point_num_, 4);
  increment_offset<float>(
      offset, 2 * simple_radial_split_fixed_focal_and_extra_num_, 4);
  ...
  increment_offset<float>(offset, 2 * pinhole_fixed_point_num_, 4);
  increment_offset<float>(offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  increment_offset<float>(offset, 12 * fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 2 * fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 6 * fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 18 * fixed_rig_position_prior_num_, 4);
  increment_offset<float>(offset, 18 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<float>(offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<float>(offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  increment_offset<float>(offset, 12 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 2 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 6 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<float>(offset, 6 * fixed_camera_pinhole_point_num_, 4);
  increment_offset<float>(
  ...
  increment_offset<float>(offset, 4 * Point_num_, 4);
  increment_offset<float>(offset, 1 * SensorFromRigLogScale_num_, 4);
  increment_offset<float>(offset, 0 * SensorFromRigLogScale_num_, 4);
  increment_offset<float>(offset, 4 * SimpleRadialCalib_num_, 4);
