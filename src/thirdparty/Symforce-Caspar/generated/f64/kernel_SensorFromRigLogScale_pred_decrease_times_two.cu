...
__global__ void __launch_bounds__(1024, 1)
  ...
  __shared__ double out_SensorFromRigLogScale_pred_dec_local[1];
  ...
  SumStore<double>(out_SensorFromRigLogScale_pred_dec_local,
                   (double*)inout_shared,
                   0,
                   global_thread_idx < problem_size,
                   r3);
  SumFlushFinal<double>(out_SensorFromRigLogScale_pred_dec_local,
