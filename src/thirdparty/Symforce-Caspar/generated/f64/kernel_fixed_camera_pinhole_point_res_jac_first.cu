...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r15 = 1.0 / r15;
    r15 = r2 * r15;
    r10 = fma(r15, r10, r16 * r3);
    r16 = r2 * r0;
    r12 = r12 * r15;
    r5 = fma(r5, r3, r8 * r12);
    r16 = fma(r5, r16, r10 * r7);
    r7 = r2 * r1;
    r4 = r14 * r6;
    r4 = fma(r15, r4, r13 * r3);
    r13 = r2 * r0;
    r9 = fma(r9, r3, r14 * r12);
    r13 = fma(r9, r13, r4 * r7);
    WriteSum2<double, double>((double*)inout_shared, r16, r13);
  };
  ...
  if (global_thread_idx < problem_size) {
    r13 = r2 * r1;
    r16 = r11 * r6;
    r16 = fma(r15, r16, r18 * r3);
    r18 = r2 * r0;
    r3 = fma(r17, r3, r11 * r12);
    r18 = fma(r3, r18, r16 * r13);
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r13 = fma(r10, r4, r5 * r9);
    r10 = fma(r10, r16, r5 * r3);
