...
GraphSolver::GraphSolver(
  ...
  nodes__Point__storage_new_best_ =
      assign_and_increment<double>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__storage_current_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  nodes__SensorFromRigLogScale__storage_check_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  facs__pinhole_fixed_pose_fixed_point__res_ = assign_and_increment<double>(
      origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  facs__fixed_rig_pinhole__res_ = assign_and_increment<double>(
      origin_ptr_, offset, 2 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_position_prior__res_ = assign_and_increment<double>(
      origin_ptr_, offset, 4 * fixed_rig_position_prior_num_, 4);
  facs__fixed_rig_sensor_position_prior__res_ = assign_and_increment<double>(
      origin_ptr_, offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  facs__fixed_rig_log_scale_prior__res_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  facs__row_fixed_rig_pinhole__res_ = assign_and_increment<double>(
      origin_ptr_, offset, 2 * row_fixed_rig_pinhole_num_, 4);
  facs__fixed_camera_pinhole_point__res_ = assign_and_increment<double>(
      origin_ptr_, offset, 2 * fixed_camera_pinhole_point_num_, 4);
  ...
  facs__pinhole_fixed_pose_fixed_point__args__calib__jac_ =
      assign_and_increment<double>(
          origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  facs__fixed_rig_pinhole__args__pose__jac_ = assign_and_increment<double>(
      origin_ptr_, offset, 12 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__sensor_from_rig_log_scale__jac_ =
      assign_and_increment<double>(
          origin_ptr_, offset, 2 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_pinhole__args__point__jac_ = assign_and_increment<double>(
  ...
  facs__fixed_rig_log_scale_prior__args__sensor_from_rig_log_scale__jac_ =
      assign_and_increment<double>(
          origin_ptr_, offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  facs__row_fixed_rig_pinhole__args__pose__jac_ = assign_and_increment<double>(
      origin_ptr_, offset, 12 * row_fixed_rig_pinhole_num_, 4);
  facs__row_fixed_rig_pinhole__args__sensor_from_rig_log_scale__jac_ =
      assign_and_increment<double>(
          origin_ptr_, offset, 2 * row_fixed_rig_pinhole_num_, 4);
  facs__row_fixed_rig_pinhole__args__point__jac_ = assign_and_increment<double>(
  ...
  nodes__Point__z_end__ =
      assign_and_increment<double>(origin_ptr_, offset, 0 * 0, 4);
  nodes__SensorFromRigLogScale__z_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__p_end__ =
      assign_and_increment<double>(origin_ptr_, offset, 0 * 0, 4);
  nodes__SensorFromRigLogScale__p_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__step_end__ =
      assign_and_increment<double>(origin_ptr_, offset, 0 * 0, 4);
  nodes__SensorFromRigLogScale__step_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__w_ =
      assign_and_increment<double>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__w_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__r_0_ =
      assign_and_increment<double>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__r_0_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__r_k_ =
      assign_and_increment<double>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__r_k_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__Mp_ =
      assign_and_increment<double>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__Mp_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  nodes__Point__precond_tril_ =
      assign_and_increment<double>(origin_ptr_, offset, 4 * Point_num_, 4);
  nodes__SensorFromRigLogScale__precond_diag_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * SensorFromRigLogScale_num_, 4);
  nodes__SensorFromRigLogScale__precond_tril_ = assign_and_increment<double>(
  ...
  facs__pinhole_fixed_pose_fixed_point__jp_ = assign_and_increment<double>(
      origin_ptr_, offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  facs__fixed_rig_pinhole__jp_ = assign_and_increment<double>(
      origin_ptr_, offset, 2 * fixed_rig_pinhole_num_, 4);
  facs__fixed_rig_position_prior__jp_ = assign_and_increment<double>(
      origin_ptr_, offset, 4 * fixed_rig_position_prior_num_, 4);
  facs__fixed_rig_sensor_position_prior__jp_ = assign_and_increment<double>(
      origin_ptr_, offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  facs__fixed_rig_log_scale_prior__jp_ = assign_and_increment<double>(
      origin_ptr_, offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  facs__row_fixed_rig_pinhole__jp_ = assign_and_increment<double>(
      origin_ptr_, offset, 2 * row_fixed_rig_pinhole_num_, 4);
  facs__fixed_camera_pinhole_point__jp_ = assign_and_increment<double>(
      origin_ptr_, offset, 2 * fixed_camera_pinhole_point_num_, 4);
...
size_t GraphSolver::get_nbytes() {
  ...
  increment_offset<double>(offset, 4 * Point_num_, 4);
  increment_offset<double>(offset, 4 * Point_num_, 4);
  increment_offset<double>(offset, 1 * SensorFromRigLogScale_num_, 4);
  increment_offset<double>(offset, 1 * SensorFromRigLogScale_num_, 4);
  increment_offset<double>(offset, 1 * SensorFromRigLogScale_num_, 4);
  ...
  increment_offset<double>(offset, 8 * fixed_rig_pinhole_num_, 4);
  increment_offset<SharedIndex>(offset, 1 * fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 4 * fixed_rig_pinhole_num_, 4);
  increment_offset<SharedIndex>(offset, 1 * fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 2 * fixed_rig_pinhole_num_, 4);
  ...
  increment_offset<double>(offset, 8 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<SharedIndex>(
      offset, 1 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<double>(offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<double>(offset, 9 * fixed_rig_sensor_position_prior_num_, 4);
  ...
  increment_offset<SharedIndex>(offset, 1 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<SharedIndex>(offset, 1 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 2 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 1 * 1, 4);
  ...
  increment_offset<double>(offset, 4 * fixed_rig_position_prior_num_, 4);
  increment_offset<double>(offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<double>(offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  increment_offset<double>(offset, 2 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 2 * fixed_camera_pinhole_point_num_, 4);
  increment_offset<double>(
      offset, 2 * simple_radial_split_fixed_focal_and_extra_num_, 4);
  ...
  increment_offset<double>(offset, 2 * pinhole_fixed_point_num_, 4);
  increment_offset<double>(offset, 2 * pinhole_fixed_pose_fixed_point_num_, 4);
  increment_offset<double>(offset, 12 * fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 2 * fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 6 * fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 18 * fixed_rig_position_prior_num_, 4);
  increment_offset<double>(
      offset, 18 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<double>(offset, 4 * fixed_rig_sensor_position_prior_num_, 4);
  increment_offset<double>(offset, 1 * fixed_rig_log_scale_prior_num_, 4);
  increment_offset<double>(offset, 12 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 2 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 6 * row_fixed_rig_pinhole_num_, 4);
  increment_offset<double>(offset, 6 * fixed_camera_pinhole_point_num_, 4);
  increment_offset<double>(
  ...
  increment_offset<double>(offset, 4 * Point_num_, 4);
  increment_offset<double>(offset, 1 * SensorFromRigLogScale_num_, 4);
  increment_offset<double>(offset, 0 * SensorFromRigLogScale_num_, 4);
  increment_offset<double>(offset, 4 * SimpleRadialCalib_num_, 4);
