...
__global__ void __launch_bounds__(1024, 1)
    SensorFromRigLogScaleNormalizeKernel(double* precond_diag,
...
void SensorFromRigLogScaleNormalize(double* precond_diag,
                                    unsigned int precond_diag_num_alloc,
                                    double* precond_tril,
                                    unsigned int precond_tril_num_alloc,
                                    double* njtr,
  ...
  SensorFromRigLogScaleNormalizeKernel<<<n_blocks, 1024>>>(
      precond_diag,
