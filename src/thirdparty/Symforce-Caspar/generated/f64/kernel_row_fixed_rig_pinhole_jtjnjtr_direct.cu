...
__global__ void __launch_bounds__(1024, 1)
    RowFixedRigPinholeJtjnjtrDirectKernel(
        double* pose_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r16 = fma(r26, r16, r25 * r9);
    WriteSum2<double, double>((double*)inout_shared, r24, r16);
  };
  FlushSumShared<2, double>(out_pose_njtr,
...
void RowFixedRigPinholeJtjnjtrDirect(
    double* pose_njtr,
    unsigned int pose_njtr_num_alloc,
    SharedIndex* pose_njtr_indices,
    double* pose_jac,
  ...
  RowFixedRigPinholeJtjnjtrDirectKernel<<<n_blocks, 1024>>>(
      pose_njtr,
      pose_njtr_num_alloc,
      pose_njtr_indices,
      pose_jac,
