...
__global__ void __launch_bounds__(1024, 1) FixedCameraPinholePointResJacKernel(
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = r19 * r1;
    r26 = r8 * r6;
    r26 = fma(r15, r26, r16 * r3);
    r24 = fma(r26, r25, r5 * r24);
    ...
    r21 = r21 * r10;
    r24 = r24 * r21;
    r26 = fma(r26, r4, r1 * r24);
    r23 = r23 * r26;
    r22 = r2 * r22;
    r24 = fma(r0, r24, r5 * r4);
    r23 = fma(r24, r22, r4 * r23);
    r9 = fma(r9, r3, r14 * r12);
    r5 = r19 * r0;
    r10 = r14 * r6;
    r10 = fma(r15, r10, r13 * r3);
    r5 = fma(r10, r25, r9 * r5);
    r13 = r0 * r5;
    r13 = fma(r21, r13, r9 * r4);
    r9 = r2 * r1;
    r20 = r1 * r5;
    r10 = fma(r10, r4, r21 * r20);
    r9 = r9 * r10;
    r9 = fma(r4, r9, r13 * r22);
  ...
  if (global_thread_idx < problem_size) {
    ...
    r25 = fma(r9, r25, r17 * r12);
    r12 = r0 * r25;
    r12 = fma(r21, r12, r17 * r4);
    r17 = r2 * r1;
    r3 = r1 * r25;
    r9 = fma(r9, r4, r21 * r3);
    r17 = r17 * r9;
    r17 = fma(r4, r17, r12 * r22);
  ...
  FlushSumShared<1, double>(out_point_njtr,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r17 = fma(r26, r26, r24 * r24);
    r22 = fma(r13, r13, r10 * r10);
    WriteSum2<double, double>((double*)inout_shared, r17, r22);
  };
  ...
  FlushSumShared<1, double>(out_point_precond_diag,
                            ...
                            (double*)inout_shared);
  if (global_thread_idx < problem_size) {
    r22 = fma(r24, r13, r26 * r10);
    r26 = fma(r26, r9, r24 * r12);
    WriteSum2<double, double>((double*)inout_shared, r22, r26);
  };
